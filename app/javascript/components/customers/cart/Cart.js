...
class Cart extends React.Component {
    constructor(props) {
        ...
        this.state = {entered_promotion: "", promotions: null};
    ...
    handlePromoChange(e) {
        ...
        this.setState({entered_promotion: e.target.value});
    }
    ...
    handleSubmit(e) {
        ...
        // Apply discount, create negative amountDue for refresh render
        for (let promo of promotionsList) {
            if (promo.promocode === this.state.entered_promotion) {
    ...
    if (this.orders === null) {
        ...
        return (
            <div className='cart-container'>
                <div><br /></div>
                <h3>Ordering From: {sessionStorage.getItem('restaurant')}</h3>
                <div><br /></div>
