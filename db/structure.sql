...
CREATE TRIGGER food_quantity_trigger AFTER INSERT ON public.comprises FOR EACH ROW EXECUTE PROCEDURE public.update_food_quantity();
...
CREATE TRIGGER promotion_num_redeemed_trigger AFTER INSERT ON public.orders FOR EACH ROW EXECUTE PROCEDURE public.update_num_redeemed();
